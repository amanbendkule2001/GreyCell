...
export const resources: Resource[] = [
  { id: "graycell-product-catalogue", slug: "graycell-product-catalogue", title: "Graycell Product Catalogue", type: "catalogue", productIds: ["oil-filled-distribution", "dry-type-distribution", "natural-ester-transformers", "foil-wound-transformers", "compact-substations"], file: { id: "graycell-product-catalogue-pdf", title: "Graycell Product Catalogue", type: "catalogue", url: "/documents/graycell-product-catalogue.pdf", access: "public", sourceStatus: "verified" }, status: "approved", seo: { title: "Graycell Product Catalogue", description: "Supplied catalogue covering compact substations, Medium Voltage SwitchGear Panels and oil/dry type transformers." } },
  { id: "graycell-transformer-brochure", slug: "graycell-transformer-brochure", title: "Graycell Transformers Brochure", type: "catalogue", productIds: ["oil-filled-distribution", "dry-type-distribution", "natural-ester-transformers", "aluminium-foil-wound-transformers", "copper-foil-wound-transformers"], file: { id: "graycell-transformer-brochure-pdf", title: "Graycell Transformers Brochure", type: "catalogue", url: "/documents/graycell-transformer-brochure.pdf", access: "public", sourceStatus: "verified" }, status: "approved", seo: { title: "Graycell Transformers Brochure | Graycell", description: "Manufacturer of Oil and Dry Type Transformers — Step Towards a Green & Sustainable World." } },
];
